...
- ⚠️ **`Mecklenburg-Vorpommern` 的台灣譯名是「梅克倫堡-佛波門」（簡稱麥佛邦）**（用戶 2026/08 明確糾正）：
  **嚴禁**寫成「前波美拉尼亞」或「西波美拉尼亞」——那是中國譯法（支語）。
  邦名譯名以 zh-tw 維基與**駐德代表處《德國常用地名翻譯對照表》**為準，
  遇到沒把握的邦名／地名先查證，別憑印象直譯德文字面。
